    ...
    if (mark.mLaneMarkType === 11 && mark.mLaneMarkName.includes("charge")) {
        ...
        return [
            ...
            mark.mLaneMarkName,
            {
                ...
                spawn_robot_name: [1, `TinyRobot${robotsBornPlaces.length}_charger`],
...
export const getYaml = (json: JSON) => {
    ...
    robotsBornPlaces.map((place: any, ind: number) => {
        ...
        currentLanes.map((lane: any, index: number) => {
            ...
            const point_1 = lane.contents.items;
            const point_2 = lane.contents.items;
            ...
            const x_1 = point_1[0].value;
            const y_1 = point_1[1].value;

            const x_2 = point_2[0].value;
            const y_2 = point_2[1].value;

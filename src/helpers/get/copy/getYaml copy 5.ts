...
export const getYaml = (json: JSON) => {
    ...
    // const marksCount = targetLaneMarks.length;
    ...
    mAreaRect && (currentLanes = currentLanes.map((lane: any) => {
        ...
        return new YAML.Document(
            [
                lane.contents.items[0].value + 4,
                lane.contents.items[1].value + 4,
                {
        ...
        //             ...lane.contents.items,
        //             items: [
        //                 { ...lane.contents.items[0], value: lane.contents.items[0].value + 4 },
        //                 { ...lane.contents.items[1], value: lane.contents.items[1].value + 4 },
        //                 { ...lane.contents.items[2] }
        //             ]
        //         }
        //     }
        // }
